...
![Navigation bar for user with no permissions](img/empty-nav.png?raw=true "EmptyNavBar")
...
![Navigation bar for user with full permissions](img/full-nav.png?raw=true "FullNavBar")
...
![Empty login page](img/login-page.png?raw=true "Login")
...
![Empty register page](img/register-page.png?raw=true "Register")
...
![Home login page](img/home-page.png?raw=true "Home")
...
![Profile options](img/profile-opt.png?raw=true "Profile options")

- If you click the "Profile" button, a new page for editing your user profile will be opened:</br>
![Edit profile page](img/profile-edit.png?raw=true "Edit profile")
...
![Offices page](img/office-page.png?raw=true "Offices")
...
![Edit office page](img/office-edit.png?raw=true "Edit office")
...
![Admin navigation bar](img/admin-nav.png?raw=true "Admin navigation bar")
...
![Users page](img/users-page.png?raw=true "Users")
...
![Emplpoyees waiting for approval page](img/employees-waiting.png?raw=true "Emplpoyees waiting for approval")
...
![Employee navigation bar](img/employee-nav.png?raw=true "Employee navigation bar")

When clicked, the following form for creating a new parcel will be loaded:</br>

![Create parcel page](img/parcels-create.png?raw=true "Create parcel")
...
![Employee registering](img/register-employee.png?raw=true "Employee registering")
...
![Creating a new rate](img/rates-create.png?raw=true "Creating a new rate")
...
![Creating a new parcel](img/parcels-create-examples.png?raw=true "Creating a new parcel")


### Examples for searching for parcels using filters

![Parcel filter example 1](img/parcels-search1.png?raw=true "Parcel filter example 1")
...
![Parcel filter example 2](img/parcels-search2.png?raw=true "Parcel filter example 2")
The above screenshot is the result of parcels being filtered by:
