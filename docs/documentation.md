...
![Profile options](img/profile-opt.png "Profile options")</br>

- If you click the "Profile" button, a new page for editing your user profile will be opened:</br>
![Edit profile page](img/profile-edit.png "Edit profile")</br>
...
![Offices page](img/office-page.png "Offices")</br>
...
![Edit office page](img/office-edit.png "Edit office")</br>
...
![Admin navigation bar](img/admin-nav.png "Admin navigation bar")</br>
...
![Users page](img/users-page.png "Users")</br>
...
![Emplpoyees waiting for approval page](img/employees-waiting.png "Emplpoyees waiting for approval")</br>
...
![Employees page](img/employees-page.png "Employees")</br>
...
![Edit employee page](img/employees-edit.png "Edit employee")</br>
...
![Rates page](img/rates-page.png "Rates")</br>
...
![Edit rate page](img/rates-edit.png "Edit rate")</br>
...
![Customers page](img/customers-page.png "Customers")</br>

### Parcels

As a customer, when you open the Parcels page, you can view the parcels which are sent by you or being delivered to you.</br>
![Parcels page seen by customer](img/parcels-customer.png "Parcels seen by customer")</br>
...
![Parcels page seen by employee/ administrator](img/parcels-page.png "Parcels seen by employee/ administrator")</br>
...
![Edit parcel page](img/parcels-edit.png "Edit parcel")</br>
...
![Employee navigation bar](img/employee-nav.png "Employee navigation bar")</br>

When clicked, the following form for creating a new parcel will be loaded:</br>

![Create parcel page](img/parcels-create.png "Create parcel")</br>
...
![Employee registering](img/register-employee.png "Employee registering")</br>
...
![Creating a new rate](img/rates-create.png "Creating a new rate")</br>
...
![Creating a new parcel](img/parcels-create-examples.png "Creating a new parcel")</br>


### Examples for searching for parcels using filters

![Parcel filter example 1](img/parcels-search1.png "Parcel filter example 1")</br>
...
![Parcel filter example 2](img/parcels-search2.png "Parcel filter example 2")</br>
The above screenshot is the result of parcels being filtered by:
